...
def shadowrocket(bypass_domains: Iterable[str], ads_domains: Iterable[str]):
    config = (
        ...
        "dns-server = quic://9.9.9.9,tls://9.9.9.9,tls://1.1.1.1,tls://8.8.8.8,https://1.1.1.1/dns-query,https://8.8.8.8/dns-query\n"
        "fallback-dns-server = quic://9.9.9.9#proxy,tls://9.9.9.9#proxy,tls://1.1.1.1#proxy,tls://8.8.8.8#proxy,https://1.1.1.1/dns-query#proxy,https://8.8.8.8/dns-query#proxy\n"
