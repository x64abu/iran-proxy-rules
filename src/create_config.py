...
def shadowrocket(bypass_domains: Iterable[str], ads_domains: Iterable[str]):
    config = (
        ...
        "dns-server = tls://1.1.1.1#proxy,https://1.1.1.1/dns-query#proxy,quic://9.9.9.9#proxy,quic://149.112.112.112#proxy,h3://94.140.14.14/dns-query#proxy\n"
        "fallback-dns-server = tls://1.1.1.1#proxy,https://1.1.1.1/dns-query#proxy,quic://9.9.9.9#proxy,quic://149.112.112.112#proxy,h3://94.140.14.14/dns-query#proxy\n"
